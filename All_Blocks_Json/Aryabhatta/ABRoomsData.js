...
const fs = require('fs');
const workbook = xlsx.readFile('ABRoomsData.xlsx');
...
fs.writeFileSync('AB.json', JSON.stringify(finalStructure, null, 2));

console.log('Excel data has been converted to custom JSON with days, subjects, and teachers and saved as AB.json.');
