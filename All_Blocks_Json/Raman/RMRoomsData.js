...
const fs = require('fs');
const workbook = xlsx.readFile('RMRoomsData.xlsx');
...
fs.writeFileSync('RM.json', JSON.stringify(finalStructure, null, 2));

console.log('Excel data has been converted to custom JSON with days, subjects, and teachers and saved as RM.json.');