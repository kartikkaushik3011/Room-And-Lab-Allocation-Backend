...
const fs = require('fs');
const workbook = xlsx.readFile('BBRoomsData.xlsx');
...
fs.writeFileSync('BB.json', JSON.stringify(finalStructure, null, 2));

console.log('Excel data has been converted to custom JSON with days, subjects, and teachers and saved as BB.json.');
